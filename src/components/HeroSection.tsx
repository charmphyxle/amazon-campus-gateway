    ...
    <section className="relative w-full h-[82svh] md:h-screen overflow-hidden">
      ...
      <div className="relative z-10 flex items-center justify-center h-full px-4 text-center">
        <div className="max-w-4xl text-white">
          <h1 className="text-4xl sm:text-5xl md:text-6xl xl:text-7xl font-bold leading-tight drop-shadow-[0_3px_10px_rgba(0,0,0,0.8)]">
            {slides[current].title}
          </h1>
          <p className="mt-3 text-xl sm:text-2xl md:text-3xl font-medium text-white/90 drop-shadow-[0_2px_6px_rgba(0,0,0,0.7)]">
            {slides[current].subtitle}
          </p>
          <p className="mt-4 text-base sm:text-lg md:text-xl text-white/85 max-w-3xl mx-auto drop-shadow-[0_2px_6px_rgba(0,0,0,0.6)]">
