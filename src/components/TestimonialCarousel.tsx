  ...
  return (
    <div className="relative max-w-6xl mx-auto">
                ...
                <CardContent className="p-8">
                  <div className="grid md:grid-cols-3 gap-8 items-center">
                    ...
                    <div className="text-center">
                      <div className="w-32 h-32 mx-auto mb-4 bg-gradient-primary rounded-full flex items-center justify-center shadow-glow">
                        {testimonial.image ? (
                          <img
      ...
      <Button
        ...
        size="icon"
        onClick={goToPrev}
        className="absolute left-4 top-1/2 transform -translate-y-1/2 bg-background/80 backdrop-blur-sm hover:bg-background shadow-elegant z-10"
      ...
      <Button
        ...
        size="icon"
        onClick={goToNext}
        className="absolute right-4 top-1/2 transform -translate-y-1/2 bg-background/80 backdrop-blur-sm hover:bg-background shadow-elegant z-10"
        disabled={testimonials.length <= 1}
      >
